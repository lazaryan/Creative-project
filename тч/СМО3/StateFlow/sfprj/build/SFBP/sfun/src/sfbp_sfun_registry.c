...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_sfbp_process_check_sum_call( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_sfbp_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_autoinheritence_call( int nlhs, mxArray * plhs[], int
 nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_sfbp_autoinheritance_info( int nlhs, mxArray * plhs[],
   int nrhs, const mxArray * prhs[] );
  if(sf_sfbp_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
...
extern unsigned int sf_sfbp_method_dispatcher(SimStruct *S, const char
...
{
  if(sf_sfbp_method_dispatcher(simstructPtr,chartName,method,data)) return 1;
  return 0;
}
extern void sfbp_terminator(void);
...
extern void sfbp_initializer(void);
extern void sfbp_debug_initialize(void);
